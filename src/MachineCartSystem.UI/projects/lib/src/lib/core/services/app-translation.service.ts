...
export class TranslateLanguageLoader implements TranslateLoader {
  ...
  public getTranslation(lang: string): any {
    ...
    switch (lang) {
      case "en":
        return of(require("../../configs/locale/en.json"));
      case "fr":
        return of(require("../../configs/locale/fr.json"));
      case "de":
        return of(require("../../configs/locale/de.json"));
      case "pt":
        return of(require("../../configs/locale/pt.json"));
      case "ar":
        return of(require("../../configs/locale/ar.json"));
      case "ko":
        return of(require("../../configs/locale/ko.json"));
      default:
    }
  }
}
